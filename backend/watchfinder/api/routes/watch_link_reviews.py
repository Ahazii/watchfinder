    ...
    for rev, lst in rows:
        ...
        items.append(
            WatchLinkReviewListItem(
                ...
                listing_description=lst.description or lst.condition_description,
                listing_web_url=lst.web_url,
                listing_image_urls=list(lst.image_urls) if isinstance(lst.image_urls, list) else None,
                listing_ended_at=lst.listing_ended_at,
                buying_options=list(lst.buying_options) if isinstance(lst.buying_options, list) else None,
                tier=rev.tier,
